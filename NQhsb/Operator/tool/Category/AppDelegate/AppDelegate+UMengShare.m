...
- (void)UMengShareSetupWithApplication:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_WechatSession appKey:@"wx5a8faf4ce5c9cac7" appSecret:@"e6a9f9c00e949815076104d000b479d9" redirectURL:@"http://mobile.umeng.com/social"];
    //设置微信朋友圈的appKey和appSecret
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_WechatTimeLine appKey:@"wx5a8faf4ce5c9cac7" appSecret:@"e6a9f9c00e949815076104d000b479d9" redirectURL:@"http://mobile.umeng.com/social"];
    //设置qq聊天的appID和appKey
