...
- (void)saveAction
{
    ...
    [self networkAddJobLogWithContent1:self.textField1.text Content2:self.textField2.text Content3:self.textField3.text Content4:self.textField4.text Content5:self.textField5.text Content6:self.textField6.text];
}
...
#pragma mark - network
- (void)networkAddJobLogWithContent1:(NSString *)content1 Content2:(NSString *)content2 Content3:(NSString *)content3 Content4:(NSString *)content4 Content5:(NSString *)content5 Content6:(NSString *)content6
{
