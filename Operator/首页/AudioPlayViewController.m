...
-(void)addUI
{
    ...
    [_titleContentTextTF setText:[NSString StringCurrentTime]];
    ...
    //初始化一个播放进度条
    _progressV = [[UIProgressView alloc] initWithFrame:CGRectMake(0, _playImage.height/2, WIDTH-_playImage.right-90, 20)];
    ...
    [_playerTimeLabel setFrame:CGRectMake(_volumeSlider.right+5, 0, 65, backView.height)];
    [_playerTimeLabel setFont:FontOfSize(10)];
    NSMutableAttributedString *playerAllTimeText;
    playerAllTimeText = [BXTTextColor getAcolorfulStringWithText1:@"00:00"
                                                           Color1:KTabBarColor
                                                            Font1:FontOfSize(10)
                                                            Text2:[NSString StringTimeWithSeconds:_player.duration]
                                                           Color2:[UIColor colorWithWhite:0.23 alpha:1.0]
                                                            Font2:FontOfSize(10)
                                                          AllText:[NSString stringWithFormat:@"00:00/%@",[NSString StringTimeWithSeconds:_player.duration]]];
...
- (void)playProgress
{
    ...
    NSMutableAttributedString *playerAllTimeText;
    playerAllTimeText = [BXTTextColor getAcolorfulStringWithText1:[NSString stringWithFormat:@"%@",[NSString StringTimeWithSeconds:_player.currentTime]]
                                                           Color1:KTabBarColor
                                                            Font1:FontOfSize(10)
                                                            Text2:[NSString stringWithFormat:@"%@",[NSString StringTimeWithSeconds:_player.duration]]
                                                           Color2:[UIColor colorWithWhite:0.23 alpha:1.0]
                                                            Font2:FontOfSize(10)
                                                          AllText:[NSString stringWithFormat:@"%@/%@",[NSString StringTimeWithSeconds:_player.currentTime],[NSString StringTimeWithSeconds:_player.duration]]];
    [_playerTimeLabel setAttributedText:playerAllTimeText];
}
//声音开关(是否静音)
