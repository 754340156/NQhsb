...
-(void)addTableView
{
    _tableView=[[UITableView alloc] initWithFrame:CGRectMake(0, 100, WIDTH, HEIGHT-100-5) style:UITableViewStylePlain];
...
-(void)addfootView
{
    ...
    _footBottomView=[[UIView alloc]initWithFrame:CGRectMake(0, HEIGHT-45,  WIDTH, 45)];
    [_footBottomView setBackgroundColor:[UIColor clearColor]];
    
    
    _nextButton=[UIButton buttonWithType:UIButtonTypeCustom];
    [_nextButton setFrame:CGRectMake(0,0, _footBottomView.width, 45)];
