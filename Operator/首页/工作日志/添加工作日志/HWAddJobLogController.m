...
- (IBAction)saveAction:(id)sender
{
    ...
    [self networkAddJobLogWithContent1:self.textField1.text
                              ...
                              Content7:self.textField7.text
                              Content8:self.textField8.text
...
#pragma mark - network
- (void)networkAddJobLogWithContent1:(NSString *)content1 Content2:(NSString *)content2 Content3:(NSString *)content3 Content4:(NSString *)content4 Content5:(NSString *)content5 Content6:(NSString *)content6   Content7:(NSString *)content7 Content8:(NSString *)content8 time:(NSString *)time
{
...
- (void)setBorder
{
    ...
    [self setKetBordType:self.textField7];
    [self setKetBordType:self.textField8];
}
