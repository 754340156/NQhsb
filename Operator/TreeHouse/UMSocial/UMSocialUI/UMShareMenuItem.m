...
#define UMSocial_Name_Label_Height 20
...
- (void)subviewsUpdate
{
    self.logoImageView.frame = CGRectMake(UMSocial_Name_Label_Height/2, 10, self.frame.size.width-UMSocial_Name_Label_Height, self.frame.size.height - UMSocial_Name_Label_Height);
